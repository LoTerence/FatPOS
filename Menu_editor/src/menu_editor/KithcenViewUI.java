 ...
 * @author Dylan
 */
public class KithcenViewUI extends javax.swing.JFrame {

    /**
     * Creates new form KithcenViewUI
     */
    public KithcenViewUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KithcenViewUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KithcenViewUI().setVisible(true);
            }
        });
    }
